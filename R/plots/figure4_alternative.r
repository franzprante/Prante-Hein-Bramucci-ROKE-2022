...
p_u_after <- plot_ly() %>% 
  add_trace(x = 0:(nrow(d4)-3),
            ...
            name = "u<sub>baseline</sub>",
            line = list(color = "lightgrey")) %>% 
  add_trace(x = 950:2000,#0:(nrow(d4)-1),
            y = d4$u[950:2000],
            type = "scatter",
            mode = "lines",
            line = list(color = "black"),
...
p_G_before <- plot_ly() %>% 
  add_trace(x = 1:950,
            ...
            line = list(color = "lightgrey")) %>% 
  add_trace(x = 1:950,#0:(nrow(d4)-1),
            y = round(d4$G_Y[1:950], digits = 2),
            type = "scatter",
            mode = "lines",
            line = list(color = "black"),
            name = "G/Y") %>% 
  add_trace(x = 1:950,#0:(nrow(d4)-1),
            y = round(d4$G_Yx[1:950], digits = 2),
            type = "scatter",
            mode = "lines",
            line = list(color = "rgb(144,144,144)",
                        dash = "dash"),
...
p_G_after <- plot_ly() %>% 
  add_trace(x = 950:2000,
            ...
            line = list(color = "lightgrey")) %>% 
  add_trace(x = 950:2000,#0:(nrow(d4)-1),
            y = round(d4$G_Y[950:2000], digits = 2),
            type = "scatter",
            mode = "lines",
            line = list(color = "black"),
            name = "G/Y") %>% 
  add_trace(x = 950:2000,#0:(nrow(d4)-1),
            y = round(d4$G_Yx[950:2000], digits = 2),
            type = "scatter",
            mode = "lines",
            line = list(color = "rgb(144,144,144)",
                        dash = "dash"),
...
p_NIIP_after <- plot_ly() %>% 
  add_trace(x = 0:(nrow(d4)-3),
            ...
            line = list(color = "lightgrey")) %>% 
  add_trace(x = 950:2000,#0:(nrow(d4)-1),
            y = d4$NIIP_Y[950:2000],
            type = "scatter",
            mode = "lines",
            line = list(color = "black"),
            name = "Domestic economy") %>% 
  add_trace(x = 950:2000,#0:(nrow(d4)-1),
            y = d4$NIIP_Yx[950:2000],
            type = "scatter",
            mode = "lines",
            line = list(color = "rgb(144,144,144)",
                        dash = "dash"),
...
# orca(
#   sub_plots,
#   file = "R/plots/figure4_alternative.pdf"
# )

orca(
  sub_plots,
  file = "R/plots/figure4_alternative.svg"
)

orca(
  sub_plots,
  file = "R/plots/figure4_alternative.png"
)
